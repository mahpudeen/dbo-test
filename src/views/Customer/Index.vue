<template>
    <v-container fill-height class="main-container">
                        ...
                        <td>
                            <v-menu offset-y>
                                ...
                                <v-list>
                                    ...
                                    <v-list-item :to="'/customer/update/'+props.item.id">
        ...
        >
            <v-card style="border-radius: 15px;">
                ...
                <v-card-title style="margin-top:-50px" class="d-flex justify-center">
                   <span class="fs20">Detail Customer</span>
                </v-card-title>
                <v-card-text>
                    <v-row class="mt-8">
                        <v-col cols="12" md="6" class="-mt24">
                            <DetailRow :name="'Code'" :value="item.code"/>
                        </v-col>
                        <v-col cols="12" md="6" class="-mt24">
                            <DetailRow :name="'Name'" :value="item.name"/>
                        </v-col>
                        <v-col cols="12" md="6" class="-mt24">
                        ...
                        <v-col cols="12" md="6" class="-mt24">
                            <DetailRow :name="'Salesperson'" :value="item.salesperson.name"/>
                        </v-col>
                        <v-col cols="12" md="6" class="-mt24">
                            <DetailRow :name="'Price Set'" :value="item.price_set.name"/>
                        </v-col>
                        <v-col cols="12" md="6" class="-mt24">
                            <DetailRow :name="'Area'" :value="item.area.name"/>
                        </v-col>
        ...
        >
            <v-card>
                <v-card-title>
                    <span class="text-title-modal">Delete Customer</span>
                </v-card-title>
                <v-card-text>
                    <span class="fs16 mt-1">Are you sure want to delete this customer?</span>
                </v-card-text>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // This method filters the data based on name and status.
            filterData(data, name, status) {
                if (status === 999) {
                ...
                return data.filter(item => {
                    return item.name.toLowerCase().includes(name.toLowerCase()) && item.status === status;
                });
            },
            ...
            // This method sends a delete request to the server for a specific customer.
            async deleteCustomer(id){
                this.modal_delete = false
                try {
                    const response = await axios.delete('/data/customer.json', { params: { id: id } });
