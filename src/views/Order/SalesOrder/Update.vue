...
<script>
    ...
    export default {
        ...
        created() {
            // The getSalesOrder method is called with the id parameter from the route to fetch the specific sales order when the component is created.
            this.getSalesOrder(this.$route.params.id);
        },
        methods: {
            // This method fetches the specific sales order based on the provided id.
            async getSalesOrder(id) {
                try {
                    ...
                    if (response.status === 200) {
                        let salesorder = response.data.find(salesorder => salesorder.id === id);
            ...
            async createMethod() {
                ...
                try {
                    ...
                    const response = await axios.put('/api/sales-order/update/'+id, this.form);
